...
4. Modifica el GET de /api/vi/champions para que, si le pasamos una QueryString con un parámetro de nombre __limit__; limite el número de campeones devueltos a dicho valor. 
Ejemplo:
...
5. Añadir un nuevo endpoint /api/v1/champion
